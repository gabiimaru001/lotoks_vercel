...
// Social media icons
const socialLinks = [
  { icon: Facebook, href: "https://facebook.com/lotoks", label: "Facebook" },
  { icon: Twitter, href: "https://twitter.com/lotoks", label: "Twitter" },
  { icon: Linkedin, href: "https://linkedin.com/company/lotoks", label: "LinkedIn" },
  { icon: Instagram, href: "https://instagram.com/lotoks", label: "Instagram" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-white/40 text-sm hidden md:block">
              Made with <span className="text-gold">♥</span> for global mobility
            </p>
          </div>
        </div>
      </div>
